import { RepairsSupply, ShipSupplyOptions } from 'space-war-shared';
import { BaseScene } from 'space-war-shared';
...
export class PlayerRepairsSupply extends RepairsSupply {
    static preload(scene: Phaser.Scene): void {
        scene.load.image(
            'repairs-canister',
            `${environment.baseUrl}/assets/sprites/repairs-canister.png`
        );
    }
