import { Ship, StandardEngine, TryCatch } from 'space-war-shared';
import { environment } from '../../../../../../environments/environment';
import { SpaceWarClient } from '../../../space-war-client';

export class PlayerStandardEngine extends StandardEngine {
    ...
    private _addUiComponents(): void {
        ...
        this._flareParticles = this.scene.add.particles(0, 0, 'flares', {
            frame: SpaceWarClient.Constants.UI.SpriteMaps.Flares.yellow,
